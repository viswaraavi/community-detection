...
# ===== Reading the graph ====== #
g <- read.graph(file="C:/Users/viswa/Desktop/project/data/1.txt", format = c("edgelist"))

# ===== Read communities file ==== #
comm = integer(vcount(g))

conn <- file("C:/Users/viswa/Desktop/project/communities.txt", open="r")
...
attrData <- read.csv("C:/Users/viswa/Desktop/project/data/1.csv")
...
op2 = influence_propagation(graph=g, comm = comm[1:324])
